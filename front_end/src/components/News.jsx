        ...
        return <Panel>
            ...
            <Panel.Footer>
                <div>
                    ...
                    {alteringDate == null ?
                        <span className={"my_date"} style={{float: "right"}}>{News.getDateByString(creationDate).toLocaleDateString()}</span> :
                        <span className={"my_date"} style={{float: "right"}}>{News.getDateByString(alteringDate).toLocaleDateString()}</span>}
                </div>
            </Panel.Footer>
        </Panel>;
    }
