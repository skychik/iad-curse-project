...
- [Proxying API Requests in Development](#proxying-api-requests-in-development)
  - ["Invalid Host Loops" Errors After Configuring Proxy](#invalid-host-header-errors-after-configuring-proxy)
...
### "Invalid Host Loops" Errors After Configuring Proxy
...
precache all of your local assets and keep them up to exitDate as you deploy updates.
